        ...
        <div class="row">
            <section class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="/abasce2/payments">Pagamentos</a></li>
                </ol>
            </section>
            <section class="container">
                <div class="col-xs-7">
                ...
                <div class="col-xs-5" align="right">
                    <a href="/abasce2/payments/create" class="btn btn-success">Cadastrar</a>
                </div>
            </section>
            <section class="container">
                <div class="row">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 10px"><a href="/abasce2/order/payments/ordid">ID</a></th>
                                        <th><a href="/abasce2/order/payments/ordcli">Cliente</a></th>
                                        <th><a href="/abasce2/order/payments/ordpla">Plano</a></th>
                                        <th><a href="/abasce2/order/payments/ordqtd">Pagamentos</a></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/abasce2/payments/<?php echo htmlspecialchars( $value1["idclient"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/detail" class="btn btn-warning btn-xs"><i class="fa fa-search"></i> Detalhes</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
                        ...
                        <div class="product-pagination text-center">
                            <nav>
                                <ul class="pagination">
                                    ...
                                    <li><a href="/abasce2/payments?page=1"><<</a></li>
                                    ...
                                    <?php } ?>
                                    <li><a href="/abasce2/payments?page=<?php echo htmlspecialchars( $lastpage, ENT_COMPAT, 'UTF-8', FALSE ); ?>">>></a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
