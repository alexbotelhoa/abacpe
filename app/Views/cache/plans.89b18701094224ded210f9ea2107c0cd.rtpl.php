        ...
        <div class="row">
            <section class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="/abasce2/plans">Planos</a></li>
                </ol>
            </section>
            <section class="container">
                <h2>Planos</h2>
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <div class="col-md-8 col-xs-6">
                                    <a href="/abasce2/plans/create" class="btn btn-success">Cadastrar</a>
                                </div>
                                <?php if( $success != '' ){ ?>
                            ...
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 10px"><a href="/abasce2/order/plans/ordid">#</a></th>
                                        <th><a href="/abasce2/order/plans/ordplan">Nome Plano</a></th>
                                        <th><a href="/abasce2/order/plans/ordvlp">Valor Plano</a></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/abasce2/plans/<?php echo htmlspecialchars( $value1["idplan"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/update" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                                            <a href="/abasce2/plans/<?php echo htmlspecialchars( $value1["idplan"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')"
