<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- ##############################################     ABOVE BODY     ############################################# -->
                    ...
                    <div class="col-sm-12">
                        <div class="footer-about-us">
                            ...
                            <div class="footer-social">
                                <a href="http://www.alexbotelhoa.com" target="_self"><i class="fa fa-globe"></i></a>
                                ...
                                <a href="https://twitter.com/alexbotelhoa" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="https://www.youtube.com/channel/UC6N_L0nZWRjcym8bnChKppw" target="_blank"><i class="fa fa-youtube"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Theme JS -->
        <script src="/abasce2/res/site/js/script.js"></script>
        <script src="/abasce2/res/site/js/app.min.js"></script>
