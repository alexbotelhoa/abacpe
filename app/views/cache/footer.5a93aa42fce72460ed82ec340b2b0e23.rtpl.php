...
-->
        ...
        <!-- jQuery UI 1.11.4 -->
        <script src="/res/admin/plugins/jQueryUI/jquery-ui.min.js"></script>
        ...
        <!-- Morris.js charts -->
        <script src="/res/admin/plugins/raphael/raphael-min.js"></script>
        ...
        <!-- daterangepicker -->
        <script src="/res/admin/plugins/daterangepicker/moment.min.js"></script>
