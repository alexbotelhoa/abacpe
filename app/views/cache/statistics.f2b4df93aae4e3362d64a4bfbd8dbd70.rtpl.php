    ...
    <section class="content2">
                    ...
                    <div class="box box-primary">
                            ...
                            <div class="box-footer">
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 0.35%</span>
                                        <h5 class="description-header">3,670.00</h5>
                                        <h5 class="description-text">MRR</h5>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        ...
                                        <h5 class="description-text">New</h5>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-red"><i class="fa fa-caret-down"></i> 28.73%</span>
                                        <h5 class="description-header">2,456.00</h5>
                                        <h5 class="description-text">Expansion</h5>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 18.69%</span>
                                        <h5 class="description-header">7,359.00</h5>
                                        <h5 class="description-text">Resurrected</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="box-footer">
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-green"><i class="fa fa-caret-down"></i> 6.66%</span>
                                        <h5 class="description-header">571.00</h5>
                                        <h5 class="description-text">Contracion</h5>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-green"><i class="fa fa-caret-down"></i> 10.95%</span>
                                        <h5 class="description-header">5,063.00</h5>
                                        <h5 class="description-text">Cancelled</h5>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-green"><i class="fa fa-caret-up"></i> 0.02%</span>
                                        <h5 class="description-header">0.04</h5>
                                        <h5 class="description-text">Tikcket</h5>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="description-block">
                                        <span class="description-percentage text-green"><i class="fa fa-caret-down"></i> 6.79%</span>
                                        <h5 class="description-header">0.27%</h5>
                                        <h5 class="description-text">Churn</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-2 text-center">
                                        <div class="knob-header">MRR</div>
                                        <label>
                                            <input type="text" class="knob" value="30" data-width="100" data-height="100" data-fgColor="#39CCCC">
                                        </label>
                                    ...
                                    <div class="col-xs-6 col-sm-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="70" data-width="100" data-height="100" data-fgColor="#00a65a">
                                        </label>
                                        <div class="knob-label">Alimentos / Bebidas</div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="80" data-width="100" data-height="100" data-fgColor="#8f26ae">
                                        </label>
                                    ...
                                    <div class="col-xs-6 col-sm-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="90" data-width="100" data-height="100" data-fgColor="#3c8dbc">
                                        </label>
                                        <div class="knob-label">Alimentos / Bebidas</div>
                                    </div>
                                    ...
                                    <div class="col-xs-6 col-sm-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="50" data-width="100" data-height="100" data-fgColor="#d54b39">
                                        </label>
                                        <div class="knob-label">Alimentos / Bebidas</div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            $(function () {
                ...
                planoChart.Line(planoChartData, lineChartOptions);
                ...
                churnChart.Line(churnChartData, lineChartOptions);
