                        ...
                        <div class="box box-info">
                            <div class="box-header">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li>&nbsp;<b>Receitas de Entrada:</b> A soma da Recurrent + New + Expansion + Resurrected, devem totalizar 100%.</li>
                                    <li>&nbsp;<b>Receitas de Saída:</b> A soma da Contraction + Cancelled, devem totalizar 100%.</li>
                                </ul>
