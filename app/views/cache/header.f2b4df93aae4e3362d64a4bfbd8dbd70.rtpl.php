...
<head>
	...
	<!-- OR Font Awesome Free v5.12.0 OR -->
	<!-- <link rel="stylesheet" href="/res/site/fa/all.min.css"> -->
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="shopping-item">
						<a href="#">Carrinho - <span class="cart-amunt">R$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
					</div>
				</div>
			</div>
		</div>
