                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-info-circle"></i></button>
                                <ul class="dropdown-menu" role="menu">
                                    <li>&nbsp;Métricas SaaS em percentuais de crescimento dentro do mês pesquisado.</li>
                                    <li>&nbsp;<b>Receitas de Entrada:</b> A soma da Recurrent + New + Expansion +
                                        Resurrected, devem totalizar 100%.
                                    </li>
                                    <li>&nbsp;<b>Receitas de Saída:</b> A soma da Contraction + Cancelled, devem
                                        totalizar 100%.
                                    </li>
                                </ul>
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-3 col-lg-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="<?php echo htmlspecialchars( $datachart["5"]["saas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                                    ...
                                    <div class="col-xs-6 col-sm-3 col-lg-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="<?php echo htmlspecialchars( $datachart["4"]["saas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                                    ...
                                    <div class="col-xs-6 col-sm-3 col-lg-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="<?php echo htmlspecialchars( $datachart["3"]["saas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                                    ...
                                    <div class="col-xs-6 col-sm-3 col-lg-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="<?php echo htmlspecialchars( $datachart["2"]["saas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-lg-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="<?php echo htmlspecialchars( $datachart["1"]["saas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-lg-2 text-center">
                                        ...
                                        <label>
                                            <input type="text" class="knob" value="<?php echo htmlspecialchars( $datachart["0"]["saas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-info-circle"></i></button>
                                <ul class="dropdown-menu" role="menu">
                                    <li>&nbsp;<b>MRR:</b> Valor formado pela soma de todas as Receitas de Entrada seja
                                        as Variáveis e as Fixas.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Fixas:</b> Valor formado pela soma de todas as Receitas de Entrada que
                                        não sofreram mudança de valores.
                                    </li>
                                </ul>
                                <i class="fa fa-bar-chart-o"></i>
                        ...
                        <div class="box box-info">
                            <div class="box-header">
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-info-circle"></i></button>
                                <ul class="dropdown-menu" role="menu">
                                    <li>&nbsp;<b>Meta:</b> Valor traçado pelo empresa como meta de crescimento da
                                        emrpesa.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Ticket Médio:</b> Valor fomado pela divisão da MRR pela quantidade de
                        ...
                        <div class="box box-success">
                            <div class="box-header">
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-info-circle"></i></button>
                                <ul class="dropdown-menu" role="menu">
                                    <li>&nbsp;<b>Entradas:</b> Valor formado pela soma de todas as MRRs dos tipos
                                        <u>New</u>, <u>Resurrected</u> e <u>Expansion</u>.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Saída:</b> Valor formado pela soma de todas as MRRs dos tipos <u>Contraction</u>
                                        e <u>Cancelled</u>.
                                    </li>
                                </ul>
                                <i class="fa fa-bar-chart-o"></i>
                        ...
                        <div class="box box-warning">
                            <div class="box-header">
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i
                                        class="fa fa-info-circle"></i></button>
                                <ul class="dropdown-menu" role="menu">
                                    <li>&nbsp;<b>New:</b> Valor formado pela soma dos pagamentos das mensalidades de <u>NOVOS</u>
                                        clientes.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Resurretecd:</b> Valor formato pela soma dos pagamentos das
                                        mensalidades de clientes <u>RECUPERADOS</u>.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Expansion:</b> Valor formado pela soma dos pagamentos das mensalidades
                                        de clientes que sofreram <u>AUMENTO</u> de valores.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Contraction:</b> Valor formado pela soma dos pagamentos das
                                        mensalidades de clientes que sofreram <u>DIMINUIÇÃO</u> de valores.
                                    </li>
                                    <li class="divider"></li>
                                    <li>&nbsp;<b>Cancelled:</b> Valor formado pela soma dos <u>NÃO PAGAMENTOS</u> das
...
<!-- jQuery Knob -->
<script src="/cpe/res/site/js/jquery.knob.js"></script>

<!-- ChartJS 1.0.1 -->
<script src="/cpe/res/site/js/Chart.min.js"></script>
