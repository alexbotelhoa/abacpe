...
<head>
	...
	<link rel="icon" href="/cpe/res/site/img/favicon.ico" type="image/x-icon">
	<title>CPE</title>
	...
	<!-- Bootstrap v3.2.0 -->
	<link rel="stylesheet" href="/cpe/res/site/css/bootstrap.min.css">

	<!-- Font Awesome Free v4.2.0 -->
	<link rel="stylesheet" href="/cpe/res/site/css/font-awesome.min.css">

	<!-- CSS v3.0.0 -->
	<link rel="stylesheet" href="/cpe/res/site/css/style.css">

	<!-- Theme style -->
	<script src="/cpe/res/site/js/core.min.js"></script>
	<link rel="stylesheet" href="/cpe/res/site/css/AdminLTE.min.css">
					...
					<div class="rd-navbar-aside">
						...
						<div class="rd-navbar-panel">
							...
							<div class="rd-navbar-brand">
								<!--Brand--><a class="brand" href="/sitecpe/"><img class="brand-logo-dark" src="/cpe/res/site/img/logo.png" alt="" width="336" height="51"/></a>
							</div>
					...
					<div class="rd-navbar-main">
						<div class="rd-navbar-nav-wrap">
							<ul class="rd-navbar-nav">
								<li class="rd-nav-item active"><a class="rd-nav-link" href="/sitecpe/">Home</a></li>
								<li class="rd-nav-item"><a class="rd-nav-link" href="/sitecpe/plans">Planos</a></li>
								<li class="rd-nav-item"><a class="rd-nav-link" href="/sitecpe/payments">Pagamentos</a></li>
								<li class="rd-nav-item"><a class="rd-nav-link" href="/sitecpe/statistics">Estatísticas</a></li>
								<li class="rd-nav-item"><a class="rd-nav-link" href="/sitecpe/about">Sobre</a></li>
								<?php if( checkPage() ){ ?>
