...
$app->post("/sitesce", function () {

    $_SESSION['UYEAR'] = $_POST['year'];
    $_SESSION['UMONTH'] = $_POST['month'];

    header("Location: /sitesce");
    exit;

});


$app->get("/sitesce/order/:page/:sort", function ($page, $sort) {

    Order::getOrder($page, $sort);

    header("Location: /sitesce/$page");
    exit;

});

$app->get("/sitesce/order/:page/:id/:subpage/:sort", function ($page, $id, $subpage, $sort) {

    Order::getOrder($subpage, $sort);

    header("Location: /sitesce/$page/$id/$subpage");
    exit;
...
$app->get("/sitesce/plans", function () {
...
$app->get("/sitesce/plans/create", function () {
...
$app->post("/sitesce/plans/create", function () {
    ...
    if ($_POST['desplan'] == '') {
        ...
        header("Location: /sitesce/plans/create");
        exit;
    }
    ...
    header("Location: /sitesce/plans");
    exit;

});

$app->get("/sitesce/plans/:idplan/update", function ($idplan) {
...
$app->post("/sitesce/plans/:idplan/update", function ($idplan) {
    ...
    if ($_POST['desplan'] == '') {
        Message::setError("Informe o NOME do plano!");
        header("Location: /sitesce/plans/$idplan/update");
        exit;
    }
...
$app->get("/sitesce/plans/:idplan/delete", function ($idplan) {
...
$app->get("/sitesce/payments", function () {
...
$app->get("/sitesce/payments/:idclient/detail", function ($idclient) {
...
$app->get("/sitesce/payments/create", function () {
...
$app->post("/sitesce/payments/create", function () {
    ...
    if ($_POST['idclient'] == '') {
        ...
        header("Location: /sitesce/payments/create");
        exit;
    }
...
$app->get("/sitesce/payments/:idclient/create", function ($idclient) {
...
$app->post("/sitesce/payments/:idclient/create", function ($idclient) {
    ...
    if ($_POST['idplan'] == '') {
        Message::setError("Selecione o PLANO do pagamento!");
        header("Location: /sitesce/payments/$idclient/create");
        exit;
    }
    ...
    header("Location: /sitesce/payments/$idclient/detail");
    exit;

});

$app->get("/sitesce/payments/:idpayment/update", function ($idpayment) {
...
$app->post("/sitesce/payments/:idpayment/update", function ($idpayment) {
    ...
    if ($_POST['dtpayment'] == '') {
        Message::setError("Informe a DATA do pagamento!");
        header("Location: /sitesce/payments/$idpayment/update");
        exit;
    }
    ...
    header("Location: /sitesce/payments/$_POST[idclient]/detail");
    exit;

});

$app->get("/sitesce/payments/:idpayment/delete", function ($idpayment) {
    ...
    if (count($checkpayment) > 0) {
        ...
        header("Location: /sitesce/payments");
    }
...
$app->get("/sitesce/statistics", function ($year = 2019, $month = 07) {
...
$app->post("/sitesce/statistics", function () {

    $_SESSION['UYEAR'] = $_POST['year'];
    $_SESSION['UMONTH'] = $_POST['month'];

    header("Location: /sitesce/statistics");
    exit;
...
$app->get("/sitesce/about", function () {
